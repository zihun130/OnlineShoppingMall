...
import atguigu.com.onlineshoppingmall.domain.H5Bean;
import atguigu.com.onlineshoppingmall.domain.webviewbean;
import butterknife.ButterKnife;
import butterknife.InjectView;
import butterknife.OnClick;

import static atguigu.com.onlineshoppingmall.adapter.HomeAdapter.GOODS_BEAN;
...
public class WebViewActivity extends AppCompatActivity {
    ...
    private void getData() {
        webbean = (webviewbean) getIntent().getSerializableExtra(HomeAdapter.WEBVIEW_BEAN);
    ...
    private void setData() {
        tvTitle.setText(webbean.getName());
    }
